    ...
    >
      ...
      >
        ...
        <div class="px-6 py-5 border-t border-gray-100 space-y-3">
          ...
          <!-- Order Buttons (Side by Side) -->
          <div class="flex gap-3 pt-1" v-if="cart.length > 0">
            <!-- WhatsApp Order -->
            <a
              :href="whatsappLink"
              target="_blank"
              @click="
                ...
                $emit('close');
              "
              class="flex-1 flex items-center justify-center py-4 bg-green-500 text-white rounded-2xl font-black shadow-lg shadow-green-100 hover:bg-green-600 hover:scale-[1.02] active:scale-95 transition-all text-center gap-1 px-2"
            >
              <svg
                width="18"
                height="18"
            ...
            <button
              ...
              class="flex-1 flex items-center justify-center py-4 bg-gray-900 text-white rounded-2xl font-black shadow-lg hover:bg-gray-800 hover:scale-[1.02] active:scale-95 transition-all text-center gap-1 px-2"
            >
